...
calendar.define_match("URU", "PER", 2022, 3, 24, 20, 30, URY_TZID, *default_venues[:URU])
calendar.define_match("COL", "BOL", 2022, 3, 24, 20, 30, URY_TZID, nil)
calendar.define_match("BRA", "CHI", 2022, 3, 24, 20, 30, URY_TZID, "Itaipava Arena Fonte Nove", "Salvador")
calendar.define_match("PAR", "ECU", 2022, 3, 24, 20, 30, URY_TZID, "Estadio Antonio Aranda", "Ciudad del Este")
calendar.define_match("ARG", "VEN", 2022, 3, 24)

calendar.define_match("PER", "PAR", 2022, 3, 29, 20, 30, URY_TZID, *default_venues[:PER])
calendar.define_match("VEN", "COL", 2022, 3, 29, 20, 30, URY_TZID, nil)
calendar.define_match("BOL", "BRA", 2022, 3, 29)
calendar.define_match("CHI", "URU", 2022, 3, 29, 20, 30, URY_TZID, nil)
calendar.define_match("ECU", "ARG", 2022, 3, 29, 20, 30, URY_TZID, "Estadio Monumental Isidro Romero Carbo", "Guayaquil")
