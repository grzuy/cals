...
calendar.define_match("COL", "PER", 2022, 1, 26)
calendar.define_match("VEN", "BOL", 2022, 1, 26)
calendar.define_match("PAR", "URU", 2022, 1, 26)
calendar.define_match("CHI", "ARG", 2022, 1, 26)
calendar.define_match("ECU", "BRA", 2022, 1, 26)

calendar.define_match("URU", "VEN", 2022, 1, 31)
calendar.define_match("PER", "ECU", 2022, 1, 31)
calendar.define_match("BRA", "PAR", 2022, 1, 31)
calendar.define_match("BOL", "CHI", 2022, 1, 31)
calendar.define_match("ARG", "COL", 2022, 1, 31)
