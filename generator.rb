...
calendar.define_match("URU", "ARG", 2021, 11, 11)
calendar.define_match("PER", "BOL", 2021, 11, 11)
calendar.define_match("BRA", "COL", 2021, 11, 11)
calendar.define_match("PAR", "CHI", 2021, 11, 11)
calendar.define_match("ECU", "VEN", 2021, 11, 11)

calendar.define_match("COL", "PAR", 2021, 11, 16)
calendar.define_match("VEN", "PER", 2021, 11, 16)
calendar.define_match("BOL", "URU", 2021, 11, 16)
calendar.define_match("ARG", "BRA", 2021, 11, 16)
calendar.define_match("CHI", "ECU", 2021, 11, 16)

calendar.define_match("COL", "PER", 2022, 1, 27)
calendar.define_match("VEN", "BOL", 2022, 1, 27)
calendar.define_match("PAR", "URU", 2022, 1, 27)
calendar.define_match("CHI", "ARG", 2022, 1, 27)
calendar.define_match("ECU", "BRA", 2022, 1, 27)

calendar.define_match("URU", "VEN", 2022, 2, 1)
calendar.define_match("PER", "ECU", 2022, 2, 1)
calendar.define_match("BRA", "PAR", 2022, 2, 1)
calendar.define_match("BOL", "CHI", 2022, 2, 1)
calendar.define_match("ARG", "COL", 2022, 2, 1)

calendar.define_match("URU", "PER", 2022, 3, 24)
calendar.define_match("COL", "BOL", 2022, 3, 24)
calendar.define_match("BRA", "CHI", 2022, 3, 24)
calendar.define_match("PAR", "ECU", 2022, 3, 24)
calendar.define_match("ARG", "VEN", 2022, 3, 24)

calendar.define_match("PER", "PAR", 2022, 3, 29)
calendar.define_match("VEN", "COL", 2022, 3, 29)
calendar.define_match("BOL", "BRA", 2022, 3, 29)
calendar.define_match("CHI", "URU", 2022, 3, 29)
calendar.define_match("ECU", "ARG", 2022, 3, 29)
